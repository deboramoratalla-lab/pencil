...
export default function PencilCanvas(){
  ...
  const runWalkthrough=()=>{
    ...
    const steps=[
      ...
      ["2 / 7 · Headline selected · shared copy; visual edits stay native",()=>{setDemo(false);setSel("headline");setAnchor(placed[0]?.id||null);setFocus(null);if(placed[0])showFormats([placed[0].id],"headline");setSubset([]);setScopeMode("all");}],
      ["3 / 7 · Choose a 9:16 group · keep other ratios independent",()=>{showFormats(vertical,"headline");setScopeMode("vertical");setSubset(vertical);setFocus(vertical);setPin(true);}],
